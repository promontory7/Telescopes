...
public class BlacklistActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.xuhai.telescopes.R.layout.em_activity_black_list);
	...
	void removeOutBlacklist(final String tobeRemoveUser) {
	    ...
	    pd.setMessage(getString(com.xuhai.telescopes.R.string.be_removing));
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            pd.dismiss();
                            Toast.makeText(getApplicationContext(), com.xuhai.telescopes.R.string.Removed_from_the_failure, 0).show();
                        }
                    });
                }
            }
	...
	private class BlacklistAdapater extends ArrayAdapter<String> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			ImageView avatar = (ImageView) convertView.findViewById(com.xuhai.telescopes.R.id.avatar);
