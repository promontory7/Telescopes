...
public class GroupsActivity extends BaseActivity {
	...
	Handler handler = new Handler(){
	    public void handleMessage(android.os.Message msg) {
            ...
            case 0:
                ...
                break;
            case 1:
                Toast.makeText(GroupsActivity.this, com.xuhai.telescopes.R.string.Failed_to_get_group_chat_information, Toast.LENGTH_LONG).show();
                break;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.xuhai.telescopes.R.layout.em_fragment_groups);

		instance = this;
		inputMethodManager = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
		grouplist = EMGroupManager.getInstance().getAllGroups();
		groupListView = (ListView) findViewById(com.xuhai.telescopes.R.id.list);
		//show group list
        groupAdapter = new GroupAdapter(this, 1, grouplist);
        groupListView.setAdapter(groupAdapter);
		
		swipeRefreshLayout = (SwipeRefreshLayout) findViewById(com.xuhai.telescopes.R.id.swipe_layout);
