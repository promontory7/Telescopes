...
import com.xuhai.easeui.ui.EaseChatFragment;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragment.EaseChatFragmentListener {
    ...
    protected void registerExtendMenuItem() {
        ...
        //增加扩展item
        inputMenu.registerExtendMenuItem(com.xuhai.telescopes.R.string.attach_video, com.xuhai.telescopes.R.drawable.em_chat_video_selector, ITEM_VIDEO, extendMenuItemClickListener);
        inputMenu.registerExtendMenuItem(com.xuhai.telescopes.R.string.attach_file, com.xuhai.telescopes.R.drawable.em_chat_file_selector, ITEM_FILE, extendMenuItemClickListener);
        if(chatType == Constant.CHATTYPE_SINGLE){
            inputMenu.registerExtendMenuItem(com.xuhai.telescopes.R.string.attach_voice_call, com.xuhai.telescopes.R.drawable.em_chat_voice_call_selector, ITEM_VOICE_CALL, extendMenuItemClickListener);
            inputMenu.registerExtendMenuItem(com.xuhai.telescopes.R.string.attach_video_call, com.xuhai.telescopes.R.drawable.em_chat_video_call_selector, ITEM_VIDEO_CALL, extendMenuItemClickListener);
        }
    }
    ...
    public void onEnterToChatDetails() {
        if (chatType == Constant.CHATTYPE_GROUP) {
            ...
            if (group == null) {
                Toast.makeText(getActivity(), com.xuhai.telescopes.R.string.gorup_not_found, 0).show();
                return;
            }
    ...
    protected void startVoiceCall() {
        if (!EMChatManager.getInstance().isConnected()) {
            Toast.makeText(getActivity(), com.xuhai.telescopes.R.string.not_connect_to_server, 0).show();
        } else {
