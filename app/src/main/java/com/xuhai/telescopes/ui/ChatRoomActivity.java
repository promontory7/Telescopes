...
import com.xuhai.telescopes.adapter.ChatRoomAdapter;
...
public class ChatRoomActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.xuhai.telescopes.R.layout.em_fragment_chatroom);

		instance = this;
		inputMethodManager = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
		roomList = EMChatManager.getInstance().getAllChatRooms();
		chatListView = (ListView) findViewById(com.xuhai.telescopes.R.id.list);
