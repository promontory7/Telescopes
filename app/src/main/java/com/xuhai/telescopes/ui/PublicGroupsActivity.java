...
public class PublicGroupsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.xuhai.telescopes.R.layout.em_activity_public_groups);

		pb = (ProgressBar) findViewById(com.xuhai.telescopes.R.id.progressBar);
		listView = (ListView) findViewById(com.xuhai.telescopes.R.id.list);
		groupsList = new ArrayList<EMGroupInfo>();
		searchBtn = (Button) findViewById(com.xuhai.telescopes.R.id.btn_search);
		
		View footView = getLayoutInflater().inflate(com.xuhai.telescopes.R.layout.em_listview_footer_view, null);
        footLoadingLayout = (LinearLayout) footView.findViewById(com.xuhai.telescopes.R.id.loading_layout);
        footLoadingPB = (ProgressBar)footView.findViewById(com.xuhai.telescopes.R.id.loading_bar);
        footLoadingText = (TextView) footView.findViewById(com.xuhai.telescopes.R.id.loading_text);
	...
	private class GroupsAdapter extends ArrayAdapter<EMGroupInfo> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			((TextView) convertView.findViewById(com.xuhai.telescopes.R.id.name)).setText(getItem(position).getGroupName());
