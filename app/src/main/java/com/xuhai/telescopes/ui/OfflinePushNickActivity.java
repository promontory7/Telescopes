...
public class OfflinePushNickActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		setContentView(com.xuhai.telescopes.R.layout.em_activity_offline_push);

		inputNickName = (EditText) findViewById(com.xuhai.telescopes.R.id.et_input_nickname);
		saveNickName = (Button) findViewById(com.xuhai.telescopes.R.id.btn_save);
		nicknameDescription = (TextView) findViewById(com.xuhai.telescopes.R.id.tv_nickname_description);
