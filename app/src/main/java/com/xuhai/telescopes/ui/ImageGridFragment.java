...
import com.xuhai.telescopes.BuildConfig;
import com.xuhai.telescopes.domain.VideoEntity;
import com.xuhai.telescopes.video.util.ImageCache;
import com.xuhai.telescopes.video.util.ImageResizer;
import com.xuhai.telescopes.video.util.Utils;
import com.xuhai.telescopes.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageThumbSize = getResources().getDimensionPixelSize(
				com.xuhai.telescopes.R.dimen.image_thumbnail_size);
		mImageThumbSpacing = getResources().getDimensionPixelSize(
				com.xuhai.telescopes.R.dimen.image_thumbnail_spacing);
		...
		mImageResizer.setLoadingImage(com.xuhai.telescopes.R.drawable.em_empty_photo);
	...
	public View onCreateView(LayoutInflater inflater,
		...
		final View v = inflater.inflate(com.xuhai.telescopes.R.layout.em_image_grid_fragment,
				container, false);
		final GridView mGridView = (GridView) v.findViewById(com.xuhai.telescopes.R.id.gridView);
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			if (vEntty.size > 1024 * 1024 * 10) {
				String st = getResources().getString(com.xuhai.telescopes.R.string.temporary_does_not);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 convertView= LayoutInflater.from(mContext).inflate(com.xuhai.telescopes.R.layout.em_choose_griditem, container,false);
				 holder.imageView=(RecyclingImageView) convertView.findViewById(com.xuhai.telescopes.R.id.imageView);
				 holder.icon=(ImageView) convertView.findViewById(com.xuhai.telescopes.R.id.video_icon);
				 holder.tvDur=(TextView)convertView.findViewById(com.xuhai.telescopes.R.id.chatting_length_iv);
				 holder.tvSize=(TextView)convertView.findViewById(com.xuhai.telescopes.R.id.chatting_size_iv);
			...
			String st1 = getResources().getString(com.xuhai.telescopes.R.string.Video_footage);
			if(position==0)
			{
				holder.icon.setVisibility(View.GONE);
				holder.tvDur.setVisibility(View.GONE);
				holder.tvSize.setText(st1);
				holder.imageView.setImageResource(com.xuhai.telescopes.R.drawable.em_actionbar_camera_icon);
			}else{
				...
				holder.imageView.setImageResource(com.xuhai.telescopes.R.drawable.em_empty_photo);
