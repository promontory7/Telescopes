...
public class DbOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String NET_TABLE_CREATE = "CREATE TABLE "
            + NetDao.TABLE_NAME + "("
            + NetDao.COLUMN_NAME_ID + " TEXT, "
            + NetDao.COLUMN_NAME_TASK + " TEXT, "
            + NetDao.COLUMN_NAME_STATUS + " TEXT, "
            + NetDao.COLUMN_NAME_TOTAL_COUNT + " TEXT, "
            + NetDao.COLUMN_NAME_TIME + " TEXT, "
            + NetDao.COLUMN_NAME_USERNAME + " TEXT, "
            + NetDao.COLUMN_NAME_SEAMAN_ROLE + " TEXT, "
            + NetDao.COLUMN_NAME_SUMMARY + " TEXT, "
            + NetDao.COLUMN_NAME_SEAMEN + " TEXT);";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(NET_TABLE_CREATE);

        Log.e("DbOpenHelper", "数据库初始化成功");
    }
