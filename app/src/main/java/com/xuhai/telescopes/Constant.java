...
public class Constant extends EaseConstant {
    ...
    //服务器地址
    public static final String serve_host_url = "http://120.25.74.159:8082/";//"http://112.74.115.90:8082/";
    ...
    /**撒网接口**/
    //获得网的列表
    public static final String getNetList = serve_host_url + "api/v1/sea_nets";
    //获得某张网的详情
    public static final String getOneNet = serve_host_url + "api/v1/sea_nets/:sea_net_id/details";
    //获得某张网匹配的匹配信息
    public static final String getOneNetReceiver = serve_host_url + "api/v1/sea_nets/:id";
    //撒网
    public static final String castNet = serve_host_url + "api/v1/sea_nets";
    //删除某张网
    public static final String deleteNet = serve_host_url + "api/v1/sea_nets/:id";
    //获得学校列表
    public static final String getSchoolList = serve_host_url + "api/v1/schools";
    //获得角色列表
    public static final String getRoleList = serve_host_url + "api/v1/roles";
}
