...
//	private ChatAllHistoryFragment conversationListFragment;
    ...
    private void initView() {
        ...
        unreadAddressLable = (TextView) findViewById(R.id.unread_friends_list_number);
        mTabs = new Button[4];
        mTabs[0] = (Button) findViewById(R.id.btn_conversation);
        mTabs[1] = (Button) findViewById(R.id.btn_friends_list);
        mTabs[2] = (Button) findViewById(R.id.btn_cast_net);
        mTabs[3] = (Button) findViewById(R.id.btn_sea);
        // 把第一个tab设为选中状态
    ...
    //侧滑设置
    private SlidingMenu initSlidingMenu(MainActivity activity) {
        localSlidingMenu = new SlidingMenu(activity);
        localSlidingMenu.setMode(SlidingMenu.LEFT);
        localSlidingMenu.setTouchModeAbove(SlidingMenu.TOUCHMODE_MARGIN);
        localSlidingMenu.setShadowWidthRes(R.dimen.slidingmenu_shadow_size);
        localSlidingMenu.setShadowDrawable(R.drawable.slidingmenu_shadow);
        localSlidingMenu.setBehindOffset(getWindowManager().getDefaultDisplay().getWidth() / 6);
    ...
    public void onSlidingmenuButtonClicked(View view) {
        switch (view.getId()) {
            case R.id.btn_slidingmenu_setting:
